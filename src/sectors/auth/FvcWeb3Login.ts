...
export class FvcWeb3Login extends FvcLoginBase {
  ...
  constructor() {
    ...
    this.#fMnemonic.setClassName("tw-w-full h120px");
  ...
  #onGetAccountError(e: any): void {
    console.error(e);
    this.#btnSubmit.setEnabled(true)
  }

  #onAccountKeyReady(fvcProgress: FvcProgress, key: any, isNew: boolean): void {

...
const _CFT_SHOP_CONFIG = {
  SHOP_NAME :
  `<input type="text" class="tight-label-like tw:box-border" placeholder="Your shop name" value="__VALUE__" data-pp-change-action="${CF_SHOP_CONFIG.ON_NAME_CHANGE}" data-pp-change-args='["$value"]'>`,
} as const;

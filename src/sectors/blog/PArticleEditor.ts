...
export class PArticleEditor extends PArticleBase {
  ...
  #pTags: SectionPanel;
  #pQuoteUrl: PanelWrapper;
  #pQuotePreview: PanelWrapper;
  #pOptions: SectionPanel;
  #pBtnList: ListPanel;
  ...
  getQuoteUrlPanel(): PanelWrapper { return this.#pQuoteUrl; }
  getQuotePreviewPanel(): PanelWrapper { return this.#pQuotePreview; }
  getOptionsPanel(): SectionPanel { return this.#pOptions; }

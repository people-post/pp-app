...
export class FvcConfigEditor extends FScrollViewContent {
  protected _fCaptain: FUserIdInput;
  protected _fMemberProfitPercent: NumberInput;
  protected _fNJoinApprovals: NumberInput;
  protected _fVotingThreshold: NumberInput;
  protected _fDaysToExpire: NumberInput;
  ...
  onInputChangeInTextArea(_fTextArea: unknown, _text: string): void {}

  setCommunityId(communityId: string | null): void {

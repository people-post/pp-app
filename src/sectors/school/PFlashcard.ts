...
export class PFlashcard extends Panel {
  ...
  protected _pChoices: Panel;
  protected _pAnswers: Panel;
  protected _pNavHint: Panel;
  ...
  getChoicesPanel(): Panel { return this._pChoices; }
  getAnswersPanel(): Panel { return this._pAnswers; }
  getNavHintPanel(): Panel { return this._pNavHint; }

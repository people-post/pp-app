const _CPT_ACTIVE_ITEM_INFO = {
  MAIN : `<div class="cart-item-info">
    <div class="flex">
      ...
      <div>
        <div id="__ID_TITLE__" class="tw-text-s-font4 tw-font-bold clickable"></div>
...
export class PActiveItemInfo extends PCartItemInfo {
  protected _pQuantity: Panel;
  protected _pBtnSaveForLater: PanelWrapper;
  ...
  getQuantityPanel(): Panel { return this._pQuantity; }
  getSaveForLaterBtnPanel(): PanelWrapper { return this._pBtnSaveForLater; }

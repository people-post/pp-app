export class RemoteError {
  ...
  static readonly T_USER = {
    ...
    E_LOGIN_FREEZE: 'Incorrect username or password, please try again in __TIME__',
  ...
  static readonly T_DEV = "Oops, we are in trouble, this is an invalid usage";
  static readonly T_CONN = 'Failed to receive response from server';
}

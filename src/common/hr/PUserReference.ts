...
const _CPT_USER_REFERENCE = {
  MAIN : `<span class="tw:inline-block tw:w-s-icon5 tw:h-s-icon5 v-middle-align">__REF_ICON__</span>
...
export class PUserReference extends Panel {
  ...
  _renderFramework(): string {
    ...
    s = s.replace("__REF_ICON__", UiUtilities.renderSvgIcon(ICON.REFRESH));

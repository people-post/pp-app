...
const _CFT_SMART_INPUT = {
  ...
  HINT_TAG :
      `<span class="clickable tw-border tw-border-[1px] tw-border-solid bdlightblue tw-rounded-[5px] tw-p-[2px]" onclick="javascript:G.action('${CF_SMART_INPUT.ON_HINT_ITEM_CHOSEN}', '__ITEM_ID__')">__VALUE__</span>`,
};

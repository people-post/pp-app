...
export class FTabbedPaneTabBar extends Fragment {
  ...
  _renderOnRender(render: any): void {
    ...
    panel.setClassName(
        "tw-border-b tw-border-b-[1px] tw-border-solid tw-border-lightgrey tw-flex tw-justify-start tw-items-center tw-overflow-x-scroll no-scrollbar tw-whitespace-nowrap");

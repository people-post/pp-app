...
const _CPT_TABBED_PANE_TAB_SMALL = {
  MAIN :
      `<div id="__ID_MAIN__" class="tabbed-pane-tab tw-flex tw-justify-start tw-items-center tw-border-solid tw-cursor-pointer tw-p-[5px] tw-text-s-font5 s-cinfotext tw-border tw-border-[1px] tw-border-lightgrey tw-border-b-0">

...
const _CPT_TABBED_PANE_TAB_MIDDLE = {
  MAIN : `<div class="tw-inline-block tw-p-[5px] tw-cursor-pointer">
      <div id="__ID_ICON__" class="bdradius5px tw-inline-block tw-w-s-icon32 tw-h-s-icon32 s-csecondarybg"></div>
    </div>
